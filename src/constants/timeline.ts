...
export const events : IEvent[] = [
  ...
  },
  {
    ...
    content: "Lincoln declared that all enslaved people should be freed. He ended all form of slavery in the United State of America."
  },
  {
    type: 'capitalism',
    year: 1611, 
    title: 'Stock Market',
    content: 'The first modern stock market originated in Amsterdam. The exchange contained just one company, The Dutch East India Company.'
  },
  {
    type: 'capitalism',
    year: 1700,
